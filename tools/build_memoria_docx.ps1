...
[void]$sb.Append("<w:document xmlns:w=""$nsW""><w:body>")
...
[void]$sb.Append('<w:sectPr><w:pgSz w:w="11906" w:h="16838"/><w:pgMar w:top="1440" w:right="1440" w:bottom="1440" w:left="1440" w:header="708" w:footer="708" w:gutter="0"/></w:sectPr></w:body></w:document>')
...
$outPath = Join-Path (Split-Path $PSScriptRoot -Parent) 'MEMORIA_Apartados_3_y_4.docx'
if (Test-Path $outPath) { Remove-Item $outPath -Force }

$fs = [System.IO.File]::Open($outPath, [System.IO.FileMode]::CreateNew, [System.IO.FileAccess]::Write)
$zip = New-Object System.IO.Compression.ZipArchive($fs, [System.IO.Compression.ZipArchiveMode]::Create)

function Add-ZipEntry {
    param($zipArchive, [string]$entryName, [string]$utf8Text, [System.Text.Encoding]$enc)
    $e = $zipArchive.CreateEntry($entryName, [System.IO.Compression.CompressionLevel]::Optimal)
    $sw = New-Object System.IO.StreamWriter($e.Open(), $enc)
    try { $sw.Write($utf8Text) } finally { $sw.Dispose() }
}

$utf8 = New-Object System.Text.UTF8Encoding $false
Add-ZipEntry $zip '[Content_Types].xml' $contentTypes $utf8
Add-ZipEntry $zip '_rels/.rels' $rels $utf8
Add-ZipEntry $zip 'word/_rels/document.xml.rels' $wordRels $utf8
